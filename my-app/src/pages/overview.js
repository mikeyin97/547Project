                ...
                <div style={{ width: "100%", height: "50%" }}>
                    ...
                    <div id="overview-menupanel">
                        ...
                        <div id="sortingOptions">
                            ...
                            <button id="byValue" onClick={() => clickedSort("value", "")}> Sort by Wastewater Discharge </button>
                        </div>
                    </div>
                    <div id="overview-menupanel1">
                        ...
                        <div id="sortingOptions">
                            ...
                            <button id="byValue1" onClick={() => clickedSort("value", "1")}> Sort by River Discharge </button>
                        </div>
                    </div>
                    <div id="overview-menupanel2">
                        ...
                        <div id="sortingOptions">
                            ...
                            <button id="byValue2" onClick={() => clickedSort("value", "2")}> Sort by Dilution Factor </button>
                        </div>
                    </div>
                    <div id="overview-menupanel3">
                        ...
                        <div id="sortingOptions">
                            ...
                            <button id="byValue3" onClick={() => clickedSort("value", "3")}> Sort by Design Capacity </button>
                        </div>
                    </div>
                    <div id="overview-menupanel4">
                        ...
                        <div id="sortingOptions">
                            ...
                            <button id="byValue4" onClick={() => clickedSort("value", "4")}> Sort by Population Served </button>
                        </div>
                    </div>
                </div>
            </div>
